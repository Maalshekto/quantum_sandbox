...
#  password.
#  Default: ''
# c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$wpLCIk/BHLZA5AJS1DsgSw$yNplskuAX1nl65L14KExHQ'
...
#  Choices: any of ['sha3_512', 'sha512', 'sha3_256', 'sha3_384', 'sha384', 'sha224', 'blake2b', 'sha3_224', 'sha256', 'md5', 'sha1', 'blake2s']
#  Default: 'sha256'
